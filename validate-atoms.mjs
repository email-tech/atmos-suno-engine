...
const GOLDEN = {
  ...
  '7|null': 'Balearic downtempo, mid chill, 90-105 BPM, medium energy, deep sub bass and a soft downtempo kit, locked tight together, a light frame-drum pulse over the groove, a warm Rhodes electric-piano motif on the melody out front, lush layered synth pads, moving through suspended add9 voicings opening into a major-seventh resolution, a soft sweeping string bed under the melody, a low pipe-organ sustain sustained underneath, a clarinet counter-line, faint and buried well under the mix, answering the lead only occasionally, wide stereo panning and slow filter modulation across the pads, chords resolve behind the melody, builds to a peak then thins out, Polished Dolby Atmos-Master Atmos -2dB',
  '42|null': 'Balearic downtempo, mid chill, 90-105 BPM, medium energy, deep FM sub-bass and a soft downtempo kit, locked tight together, a light frame-drum pulse over the groove, a warm arpeggiated synth lead on the melody out front, lush layered synth pads, moving through a slow minor-to-relative-major progression over eight-bar cycles, soft layered strings under the melody, a low pipe-organ sustain sustained underneath, a clarinet counter-line, faint and buried well under the mix, answering the lead only occasionally, an occasional glockenspiel accent in the gaps, LFO, chorus and phaser movement evolving across the synth layers, chords resolve behind the melody, builds to a peak then thins out, Polished Dolby Atmos-Master Atmos -2dB',
};
let parityFail = 0;
